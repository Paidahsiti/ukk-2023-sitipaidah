...
<header id="header" class="header fixed-top d-flex align-items-center bg-primary">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ route('dashboard') }}" class="logo d-flex align-items-center">
            <img src="{{ asset('img/mylogo.png') }}" alt="poto" srcset="">
            <span class="d-none d-lg-block text-light ms-2">YUKngadu!</span>
        </a>
        ...
        <ul class="d-flex align-items-center">
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <span class="d-none d-md-block pe-2 text-light">{{ Auth::user()->name }}</span>
                    <img src="{{ asset('img/small.png') }}"style="width:35px; height:30px" alt="Profile"
